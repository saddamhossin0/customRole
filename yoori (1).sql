...
(3, 3, 'F7kQRGAIKYfuGkq0ZR8aQuI1WUJvGsvM', 1, '2023-01-03 06:26:51', '2023-01-03 06:26:51', '2023-01-03 06:26:51');
...
CREATE TABLE `blog_category_languages` (
  ...
  `meta_description` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'meta description for seo',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `delivery_heroes` (
  ...
  `driving_licence_image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `fonts` (
  ...
  `regular` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `medium` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `bold` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0,
  `local` varchar(255) COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'en',
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(5, 'http://localhost/yoori_release_155/login-admin-seller', 'POST', '::1', 'Google Chrome', 'windows', 1, '2023-01-03 06:12:56', '2023-01-03 06:12:56'),
(6, 'http://localhost/yoori_release_155/login-admin-seller', 'POST', '::1', 'Google Chrome', 'windows', 3, '2023-01-03 06:28:12', '2023-01-03 06:28:12');
...
CREATE TABLE `media` (
  ...
  `image_variants` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(1, 'product', '{\"create\":\"product_create\",\"delete\":\"product_delete\",\"read\":\"product_read\",\"update\":\"product_update\"}', '2023-01-16 04:41:09', '2023-01-16 04:41:09'),
(2, 'order', '{\"create\":\"order_create\",\"delete\":\"order_delete\",\"read\":\"order_read\"}', '2023-01-16 04:42:08', '2023-01-16 04:42:08'),
(3, 'ceo', '{\"create\":\"ceo_create\",\"delete\":\"ceo_delete\",\"read\":\"ceo_read\",\"update\":\"ceo_update\"}', '2023-01-16 04:50:39', '2023-01-16 04:50:39');
...
(10, 1, 'GWfC6DTUEiHN8Yk8EwzKy2TMLKARFQUF', '2023-01-03 06:12:56', '2023-01-03 06:12:56'),
(11, 3, 'WI9kpsCJLlac8cgyJdVLi9OXdkRRVP7g', '2023-01-03 06:28:12', '2023-01-03 06:28:12'),
(12, 1, 'ocJt51vp9xJVOncq0TO82Yk4G7bk5mMg', '2023-01-15 05:46:27', '2023-01-15 05:46:27'),
(13, 1, 'DpdmFZATk2NXm9GwgzC8cbUTQtmRmXvQ', '2023-01-15 21:59:21', '2023-01-15 21:59:21'),
(14, 1, 'D6pX0PpEexSTbDHoY2T1aFOFzOdes0BN', '2023-01-15 22:01:24', '2023-01-15 22:01:24'),
(15, 1, 'BRRFImCpEDu4Z36i9XGQROM6Wobu7tIQ', '2023-01-15 22:09:59', '2023-01-15 22:09:59'),
(16, 1, '12qVJYnZNWd69A13hy6OSHrh5ZTjNO2E', '2023-01-15 22:13:30', '2023-01-15 22:13:30'),
(17, 1, 'KL8xR6GkfkOp3VXQ228Fms8kMf7AvDTV', '2023-01-15 22:31:03', '2023-01-15 22:31:03'),
(18, 1, 'xUjKRr95GDSrQi45LzjiZgw6ACkxk4Ix', '2023-01-16 02:19:47', '2023-01-16 02:19:47'),
(19, 1, 'ePcmzVNIStybL3ovyC53tidoJrWHpQuF', '2023-01-16 05:24:04', '2023-01-16 05:24:04');
...
CREATE TABLE `products` (
  ...
  `selected_variants` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `selected_variants_ids` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `thumbnail` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `images` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `description_images` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `estimated_shipping_days` text COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'estimated time of delivering the product',
  `cash_on_delivery` tinyint(4) NOT NULL DEFAULT 0 COMMENT '0 not available, 1 available',
  `meta_image` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `product_file` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `product_languages` (
  ...
  `pdf_specification` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(4, NULL, 'Manager', '[\"product_create\",\"product_read\",\"order_create\",\"ceo_create\"]', '2023-01-16 05:36:22', '2023-01-16 05:36:22'),
(6, NULL, 'Super admin', '[\"product_create\",\"product_delete\",\"product_read\",\"product_update\"]', '2023-01-16 06:33:01', '2023-01-16 06:33:01');
...
CREATE TABLE `sellers` (
  ...
  `tax_paper` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `logo` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `banner` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shop_page_contents` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mobile_shop_page_contents` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shop_banner_id` bigint(20) UNSIGNED DEFAULT NULL,
  `shop_banner` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `shop_tagline` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
CREATE TABLE `seller_payouts` (
  ...
  `payment_to` mediumtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(1, 'en', 'current_version', '155', '2022-04-06 00:07:39', '2022-12-21 05:37:17'),
...
(246, 'en', 'purchase_code', '2e1c205f-b293-46cb-991c-9673627e1b79', '2022-07-21 17:21:27', '2022-12-21 10:39:04'),
...
(248, 'en', 'version_code', '1.5.5', '2022-08-08 11:13:06', '2022-12-21 05:37:17'),
...
CREATE TABLE `supports` (
  ...
  `ticket_body` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE `users` (
  ...
  `user_type` enum('admin','staff','seller','customer','delivery_hero','walk_in') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `lang_code` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT 'en',
  `is_password_set` tinyint(4) NOT NULL DEFAULT 1 COMMENT '0 for social login',
  `images` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `socials` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL COMMENT 'it will be array data',
